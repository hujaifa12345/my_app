        ...
        <div className="w-full h-231 bg-cover bg-center" style={{backgroundImage: "url('/codioful-formerly-gradienta-OzfD79w8ptA-unsplash.jpg')"}}>
            ...
            <div className="flex justify-between">
                ...
                <div className="h-115 w-35/100 pt-4">
                    <h1 className="inline-block text-9xl text-white font-bold">250</h1><p className="inline-block text-2xl text-white font-bold ml-4">Beds</p>
                    ...
                    <button className="flex text-[15px] px-7 py-2 text-white font-bold bg-[#0090ca] rounded-3xl hover:bg-white hover:text-blue-950 transition ">Learn More<IoMdArrowForward className="  mt-1 ml-2" /></button>
                </div>
            </div>
