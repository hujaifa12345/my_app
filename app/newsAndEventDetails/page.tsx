...
export default function(){
    ...
    return(
        <main>
            ...
            <div className=" flex flex-col justify-between px-40 py-10 text-white w-full h-97.5 backdrop-blur-md bg-gray-800">
                <div className="text-white text-medium flex items-center gap-2">
                    <Link href="/" className="text-gray-400">Home</Link>
                    <span className="font-bold">•</span>
                    <Link href="/department" className="text-gray-400">News</Link>
                    <span className="font-bold">•</span>
                    <span className=" font-medium">Detail</span>
                </div>

                <div>
                    <h1 className="text-5xl font-bold">Tofazzal Hossain</h1>
            ...
            <div className="w-[85%] mx-auto mt-15 mb-40 ">

                <div className="flex my-18 text-gray-800 ">
                    ...
                    <div className="flex flex-col gap-7 w-[67%] ">
                        <h2 className="text-3xl font-bold">Comprehensive care at Unico Hospital</h2>

                        <img src="/ai-generative-portrait-of-confident-male-doctor-in-white-coat-and-stethoscope-standing-with-arms-crossed-and-looking-at-camera-photo.jpg" alt="image" className="max-h-150 w-fit"/>
